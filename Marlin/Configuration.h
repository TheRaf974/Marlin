...
#define STRING_CONFIG_H_AUTHOR "(Raphael Boyer, Artilect CR-10 S5 with BLTouch and PSU control)" // Who made the changes.
...
#define MACHINE_UUID "4745bbda-9fde-4a36-8852-5df488f72362"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  22.57 // value from last official update
    #define DEFAULT_Ki   1.72 // value from last official update
    #define DEFAULT_Kd  73.96 // value from last official update
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96 }  // { 80, 80, 400, 93 } from factory settings and last official update but underextruding
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25 }         // { 300, 300, 5, 25 } from last official update
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 100, 1000 }       // { 300, 300, 100, 1000 } from last official update
 ...
 */
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves         // 500 from last official update
#define DEFAULT_RETRACT_ACCELERATION  500    // E acceleration for retracts                           // 500 from last official update
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves // 1000 from last official update
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08 // (mm) Distance from real junction edge   // 0.4 * jerk^2 / acceleration = 0.4 * 10^2 / 500 = 0.08
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.2, -5.6, -0.9 }
...
#define Y_MAX_POS Y_BED_SIZE + 5.6 // allow the probe to measure the last row of the mesh, at the front of the bed
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 77.8, 81.4, 82.2, 78.6 } // (mm) Left, Front, Right, Back insets
